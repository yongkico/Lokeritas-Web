        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group position-relative">
                            <input class="text-secondary" type="checkbox" id="inlineCheckbox1" value="option1">
                            <label class="text-secondary">Tutup Komentar</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group position-relative">

                            <button type="submit" class="btn btn-primary pull-right">Terbitkan</button>

...
?>
            ...
            <div id="navigation">
                ...
                <ul class="navigation-menu">
                    ...
                    <li class="has-submenu">
                        <a href="#"><i class="mdi mdi-account mr-2"
                                style="color: gray; font-size:16px"></i><?= $_SESSION['nama_depan'];?></a><span
            ...
            <div class="row">
                <div class="col-12">
                    <div class="tab-content mt-2" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="satu-job" role="tabpanel"
                            aria-labelledby="satu-job-tab">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div
                                        ...
                                        <div class="p-4">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-3">
                                                    <div>
                                                        <h5 class="f-18"><a href="lowongan-detail.php"
                                                                class="text-dark"><?php echo $nama_pekerjaan;?></a></h5>
                                                ...
                                                <div class="col-md-3">
                                                    <div>
                                                        <p class="text-muted mb-0"><i
                                                                class="mdi mdi-apps text-primary mr-2"></i><?php echo $sektor_perusahaan;?></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div>
                                                        <p class="text-muted mb-0"><i
                                                                class="mdi mdi-map-marker text-primary mr-2"></i><?php echo $alamat_lowongan;?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="p-3 bg-light">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div>
                                                        <p class="text-muted mb-0 mo-mb-2">Jenis Disabilitas : <span
                                                                class="text-dark">Semua Jenis Disabilitas</span></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div>
                                                        <p class="text-muted mb-0 mo-mb-2">Tutup : <span
                                                                class="text-dark"> <?php echo $lowongan_tutup;?> </span></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <a href="lowongan-detail.php"
                        ...
                        <div class="tab-pane fade" id="dua-job" role="tabpanel" aria-labelledby="dua-job-tab">
                            <div class="row">
                                <div class="col-lg-12">
                        ...
                        <div class="tab-pane fade" id="tiga-job" role="tabpanel" aria-labelledby="tiga-job-tab">
                            <div class="row">
                                <div class="col-lg-12">
                ...
                <div class="col-lg-12 mt-4 pt-2">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination job-pagination mb-0 justify-content-center">
                            ...
                            <li class="page-item"><a class="page-link" id="satu-job-tab" data-toggle="pill"
                                    href="#satu-job" role="tab" aria-controls="satu-job" aria-selected="false">1</a>
                            </li>
                            <li class="page-item"><a class="page-link" id="dua-job-tab" data-toggle="pill"
                                    href="#dua-job" role="tab" aria-controls="dua-job" aria-selected="false">2</a></li>
                            <li class="page-item"><a class="page-link" id="tiga-job-tab" data-toggle="pill"
                                    href="#tiga-job" role="tab" aria-controls="tiga-job" aria-selected="false">3</a>
                            </li>
                            <li class="page-item">
 ...
 <!-- blog start -->
                ...
                <div class="col-lg-4 col-md-6 mt-4 pt-2">
                    <div class="blog position-relative overflow-hidden shadow rounded">
                        <div class="position-relative overflow-hidden">
                            <img src="https://3.bp.blogspot.com/-bwglrylRsGE/VFw2u5RigDI/AAAAAAAAAEM/nHzodiYd5kU/s1600/02.jpg"
                                class="img-fluid rounded-top" alt="">
                            <div class="overlay rounded-top bg-dark"></div>
                        </div>
                        <div class="content p-4 bg-white">
                            <h4><a href="#" class="title text-dark"><?php echo $judul_tipskarir;?></a>
                            </h4>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mt-4 pt-2">
                    <div class="blog position-relative overflow-hidden shadow rounded">
                        <div class="position-relative overflow-hidden">
                            <img src="https://v-images2.antarafoto.com/penyandang-disabilitas-mf7nx1-prv.jpg"
                                class="img-fluid rounded-top" alt="">
                            <div class="overlay rounded-top bg-dark"></div>
                        ...
                        <div class="content p-4 bg-white" style="padding: 10px 24px 24px 24px ! important">
                            <div>
                                <p class=" mb-0" style="float: left"><i class="mdi mdi-account text-secondary"></i> <a
                                        href="javascript:void(0)" class="text-secondary user">Samsul Sinaga</a></p>
                                            ...
                                            <div class="col-lg-9 col-md-6">
                                                <div class="registration-form-box">
                                                    ...
                                                    <input type="text" id="autocomplete" name="autocomplete"
                                                        class="form-control rounded registration-input-box autocomplete-selected"
                            ...
                            <div class="clearfix">
                                <div class="testi-img float-left mr-3">
                                    <img src="https://via.placeholder.com/400X400//88929f/5a6270C/O https://placeholder.com/"
                                        height="64" alt="" class="rounded-circle shadow">
                                </div>
    ...
    <section class="section pb-0"
        style="background: url('https://www.expatica.com/app/uploads/2018/11/Networking-1-1920x1080.jpg') center center;">
        <div class="bg-overlay"></div>
        <div class="container">
            <div class="row align-items-center">
                    ...
                    <div class="app-about-content">
                        <div class="app-about-desc text-white">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="list-inline-item"><a href="javascript:void(0)"><img src="images/google.png"
                                            class="mt-2" height="60" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 bg-info rounded"
                                style="padding:50px 50px 50px 50px;border:7px solid white">
                                <p class="text-white" style="font-size: 24px;text-align:center">Sebagai Penyandang
                                    Disabilitas Pencari Kerja</p>
                                <p style="text-align: center;margin-top:30px"><a href="daftar-disabilitas.php"
                                        class="btn btn-light btn-lg" style="margin-right: 10px ! important">Daftar</a>
                                </p>
                            </div>
                            <div class="col-lg-6 bg-warning rounded"
                                style="padding:50px 50px 50px 50px;border:7px solid white">
                                <p class="text-white" style="font-size: 24px;text-align:center">Sebagai Penyedia Kerja
                                    Penyandang Disabilitas</p>
                                <p style="text-align: center;margin-top:30px"><a href="daftar-penyedia-kerja.php"
                                        class="btn btn-light btn-lg" style="margin-right: 10px ! important">Daftar</a>
                                </p>
                            </div>
